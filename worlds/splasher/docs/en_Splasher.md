...
As for locations, game's collectables (mainly, *Splashers*) are randomized and reward a random Archipelago item upon collecting them. You can also enable Time Attack locations.
...
- Logic, though now unlikely to have ground-breaking issues
- Feedback implementation : you'll not have in-game Archipelago messages. It is highly recommended to use a tracker during your playthrough.